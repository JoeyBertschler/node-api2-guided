...
// const router = require('express').Router() //one liner version of blw

const express = require('express')
const router = express.Router()

router.get('/', (req, res) => { //click server 3x, ctrl + d
  ...
  // this is an escape symbol: "\" used for http requests in terminal,
  // not needed in postman or browser

  // need to restart debugger whenever we make
  // changes to the code (green circle arrow)

  // must set breakpoints for synrchonous code